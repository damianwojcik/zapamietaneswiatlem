...
function enqueue_scripts() {
    ...
    wp_enqueue_script( 'lightbox', THEME_URL . '/assets/js/vendor/lightbox.min.js', '', NULL);
    wp_enqueue_script( 'barbajs', 'https://cdnjs.cloudflare.com/ajax/libs/barba.js/1.0.0/barba.min.js', '', NULL);
